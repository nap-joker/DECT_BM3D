...
parser.add_argument('--net_name', type=str, default='Dual-CT-RDUNet', help='name of net')
...
parser.add_argument('--layer_num', type=int, default=7, help='D,11-7.5G')
...
parser.add_argument('--loss_mode', type=str, default='Ista-net', help='vggloss,midloss,L1,L2,Fista-net')
