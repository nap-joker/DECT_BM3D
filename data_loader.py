...
def CT_dataloader(num_work,batch_size):
    # Load Adipose data
    Phantom_Adipose_Name = './training_data/Phantom_Adipose.npy'
    ...
    Phantom_Fibroglandular_Name = './training_data/Phantom_Fibroglandular.npy'
    ...
    Phantom_Calcification_Name = './training_data/Phantom_Calcification.npy'
